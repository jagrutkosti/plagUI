...
public class PlagUiApp {

    private static final Logger log = LoggerFactory.getLogger(PlagUiApp.class);

    private final Environment env;

    public PlagUiApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PlagUiApp.class);
